# Important Notes for Running the Scripts

Before running the scripts, make sure to modify the file paths in each R script so they match the location on your computer. Otherwise, the code will not run properly.
